...
public class InspectionTask {
    ...
    public InspectionTask(PipeSegment pipeSegment, String title, String inspector, OffsetDateTime scheduledAt) {
        this.pipeSegment = pipeSegment;
        this.title = title;
        this.inspector = inspector;
        this.scheduledAt = scheduledAt;
        this.status = InspectionTaskStatus.PENDING;
    }
    ...
    public void start() {
        this.status = InspectionTaskStatus.IN_PROGRESS;
    }

    public void complete(String result) {
        this.status = InspectionTaskStatus.COMPLETED;
        this.result = result;
    }
}
